...
function AnimatedStatCard({ label, rawValue, formatter, sub, positive, neutral = false, large = false, children }) {
...
export default function DashboardSummary() {
  ...
  // Skeleton loading: show for first 1.5s after mount (while prices may not have loaded)
  ...
  const showSkeleton = isLoading && !pricesLoaded && totalValue === 0;
